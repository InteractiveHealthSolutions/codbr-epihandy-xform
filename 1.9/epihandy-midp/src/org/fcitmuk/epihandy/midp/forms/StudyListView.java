...
public class StudyListView extends AbstractView implements CommandListener, ModelListener {
	...
	public StudyListView(Model model) {
		...
		screen.addCommand(DefaultCommands.cmdLogout);
		...
		screen.addCommand(DefaultCommands.cmdViewSessionLog);
	}
	...
	public void commandAction(Command c, Displayable d) {
		...
		try {
			...
			else if(c == DefaultCommands.cmdViewSessionLog){
				controller.loadSessionReferenceLog();
			}
			else if (c == DefaultCommands.cmdLogout) {
				controller.logout(this.getScreen());
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
