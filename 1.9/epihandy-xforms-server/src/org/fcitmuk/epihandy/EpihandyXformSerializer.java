...
public class EpihandyXformSerializer {
	...
	public void serializeFormData(OutputStream os, String xform, String sessionReference, String formData) throws Exception {
		DataOutputStream dos = new DataOutputStream(os);
		FormData formDataObj = EpihandyXform.fromXMLToFormData(xform, formData);
		formDataObj.setDataId(Integer.valueOf(sessionReference));
		formDataObj.write(dos);
	}
