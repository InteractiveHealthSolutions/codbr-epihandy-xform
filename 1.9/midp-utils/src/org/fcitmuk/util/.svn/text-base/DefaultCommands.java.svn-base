...
public class DefaultCommands {
	...
	/** Command in the menu for logging out (returning to the login screen) */ 
	public static  Command cmdLogout = new Command(MenuText.LOGOUT(), MenuText.LOGOUT(), Command.EXIT, 4); 
	...
	/** Command for showing upload errors */
	public static Command cmdShowErrors = new Command(MenuText.SHOW_ERRORS(),Command.HELP,1);
	
	/** Command for showing upload errors */
	public static Command cmdClearErrors = new Command(MenuText.CLEAR_ERRORS(),
			Command.HELP, 1);
	...
	/** Command in the menu to download and edit submitted data */
	public static  Command cmdDownloadData = new Command(MenuText.DOWNLOAD_DATA(), MenuText.DOWNLOAD_DATA(), Command.SCREEN, 2);
	
	/** Command in the menu to configure application */
	public static  Command cmdSettings = new Command(MenuText.SETTINGS(), MenuText.SETTINGS(), Command.SCREEN, 4);	
	
	public static Command cmdViewSessionLog = new Command(MenuText.VIEW_UPLOAD_LOG(), MenuText.VIEW_UPLOAD_LOG(), Command.SCREEN, 3);
}
