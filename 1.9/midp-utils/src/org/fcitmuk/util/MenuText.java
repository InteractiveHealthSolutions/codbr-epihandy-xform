...
public class MenuText {
	...
	public static String LOGOUT_PROMPT() {
		return getText("LOGOUT_PROMPT");
	}
	...
	public static String DOWNLOAD_DATA_PROMPT() {
		return getText("DOWNLOAD_DATA_PROMPT");
	}
	...
	public static String SESSION_REFERENCE_PROMPT() {
		return getText("SESSION_REFERENCE_PROMPT");
	}
	
	public static String DOWNLOADING_DATA() {
		return getText("DOWNLOADING_DATA");
	}
	...
	public static String DATA_DOWNLOAD_SAVED() {
		return getText("DATA_DOWNLOAD_SAVED");
	}
	...
	public static String INVALID_SESSION_REFERENCE() {
		return getText("INVALID_SESSION_REFERENCE");
	}
	...
	public static String REQUIRED_MISSING() {
		return getText("REQUIRED_MISSING");
	}
	...
	public static String SERVER_URL() {
		return getText("SERVER_URL");
	}

	public static String SERVER_ADDRESS() {
		return getText("SERVER_ADDRESS");
	}

	public static String ADVANCED_VIEW() {
		return getText("ADVANCED_VIEW");
	}
	...
	public static String PROBLEM_UPLOAD_NO_FORM_DATA(){
		return getText("PROBLEM_UPLOAD_NO_FORM_DATA");	
	}
	
	public static String UPLOAD_REFERENCE(){
		return getText("UPLOAD_REFERENCE");
	}
	
	public static String UPLOAD_REFERENCES(){
		return getText("UPLOAD_REFERENCES");
	}

	public static String VIEW_UPLOAD_LOG() {
		return getText("VIEW_UPLOAD_LOG");
	}
	
	public static String CLEAR_UPLOAD_LOG() {
		return getText("CLEAR_UPLOAD_LOG");
	}
	
	public static String UPLOAD_LOG() {
		return getText("UPLOAD_LOG");
	}
	
	public static String NO_UPLOAD_REFERENCES() {
		return getText("NO_UPLOAD_REFERENCES");
	}
	
	public static String INVALID_CONNECTION_SETTINGS(){
		return getText("INVALID_CONNECTION_SETTINGS");
	}
	
	public static String ACCESS_DENIED_RELOGIN(){
		return getText("ACCESS_DENIED_RELOGIN");
	}

	public static String FORM_SAVE_INCOMPLETE(){
		return getText("FORM_SAVE_INCOMPLETE");
	}
	
	public static String FORM_SAVE_MULTIPLE_INCOMPLETE(){
		return getText("FORM_SAVE_MULTIPLE_INCOMPLETE");
	}
	...
	public static String Client_Name(){
		return getText("Client_Name");
	}
	
	public static String Client_Vendor(){
		return getText("Client_Vendor");
	}
	
	public static String Client_Version(){
		return getText("Client_Version");
	}
	
	public static String Server_Protocol(){
		return getText("Server_Protocol");
	}

	public static String SERVER_ADDRESS_PROBLEM(){
		return getText("SERVER_ADDRESS_PROBLEM");
	}
	
	public static String ERROR_CODE(){
		return getText("ERROR_CODE");
	}
	
	public static String SERVERDOWN_PROBLEM(){
		return getText("SERVERDOWN_PROBLEM");
	}
