...
public class EpihandyConstants {
	...
	public static final String KEY_LAST_SELECTED_FORMDEF =  "LAST_SELECTED_FORMDEF";
	
	public static final String KEY_LAST_SELECTED_FORMDATA =  "LAST_SELECTED_FORMDATA";
}
