...
public class XformObsPatientEdit {
	...
	private static void updatePersonAddress(Patient patient, String attributeValue, String dataValue, Element node) {
		...
		else if (XformBuilder.NODE_NAME_ADDRESS3.equals(attributeValue))
			pa.setAddress3(dataValue);
		else if (XformBuilder.NODE_NAME_ADDRESS4.equals(attributeValue))
	...
	private static void updatePersonAttribute(Patient patient, String attributeValue, String dataValue, Element node) {
		PersonAttributeType personAttributeType = Context.getPersonService().getPersonAttributeTypeByName(attributeValue);
