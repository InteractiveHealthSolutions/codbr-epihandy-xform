...
public final class XformBuilder implements GlobalPropertyListener {
	...
	public static final String ATTRIBUTE_FIELD_HINT = "field_hint";
	...
	public static final String NODE_PATIENT_NEW_PATIENT = "patient.new_patient";
	...
	public static final String NODE_PATIENT_DEATHDATE = "patient.death_date";
	
	public static final String NODE_PATIENT_PATIENT_DEAD = "patient.dead";
	...
	public static final String NODE_DEATHDATE = "death_date";
	
	public static final String NODE_PATIENT_DEAD = "dead";
	...
	public static final String NODE_NAME_PERSON_ADDRESS = "person_address";
	...
	public static final String NODE_NAME_ADDRESS3 = "address3";
	
	public static final String NODE_NAME_ADDRESS4 = "address4";
	
	public static final String NODE_NAME_ADDRESS5 = "address5";
	
	public static final String NODE_NAME_ADDRESS6 = "address6";
	...
	public static String getXform4mDocuments(Document schemaDoc, Document templateDoc) throws Exception {
		...
		parseTemplate(modelNode, formNode, formNode, bindings, groupNode, problemList, problemListItems, 0, DOMUtil.isNewPatientXformDoc(formNode));
	...
	public static void parseTemplate(Element modelElement, Element formNode, Element formChild, Hashtable bindings,
	                                 ...
	                                 Hashtable<String, String> problemListItems, int level, boolean isNewPatientXformDoc) {
		level++;
		...
		for (int i = 0; i < numOfEntries; i++) {
			...
			if ((child.getAttributeValue(null, ATTRIBUTE_OPENMRS_CONCEPT) != null && level >= 1 /*!child.getName().equals(NODE_OBS)*/)
				...
				if (!name.equalsIgnoreCase(NODE_PROBLEM_LIST)) {
					...
					if (isTableFieldNode(child)) {
						...
						setTableFieldBindingAttributes(name, bindNode, isNewPatientXformDoc);
			...
			if (isTableFieldNode(child)) {
				Element controlNode = buildTableFieldUIControlNode(child, bodyNode, child.getAttributeValue(null, ATTRIBUTE_FIELD_HINT));
				...
				if (name.equalsIgnoreCase(NODE_ENCOUNTER_LOCATION_ID) && CONTROL_SELECT1.equals(controlNode.getName()))
					...
					populateProviders(controlNode, modelElement, bodyNode);
			...
			parseTemplate(modelElement, formNode, child, bindings, bodyNode, problemList, problemListItems, level, isNewPatientXformDoc);
		}
	}
	 ...
	 */
	private static Element buildTableFieldUIControlNode(Element node, Element bodyNode, String fieldHint) {
		...
		hintNode.addChild(Element.TEXT, fieldHint);
		controlNode.addChild(Element.ELEMENT, hintNode);
	 ...
	 */
	private static void populateProviders(Element controlNode, Element modelNode, Element groupNode) {
		try {
	 ...
	 */
	private static void setTableFieldBindingAttributes(String name, Element bindNode, boolean isNewPatientDoc) {
