...
public class AlertMessage implements CommandListener {
	...
	public void commandAction(Command c, Displayable d) {
		try{
			//The Alert.DISMISS_COMMAND is for the sonny errickson which always add it regardless
			//of how many commands you have already added. Something which seems like
			//contrary to the J2ME spec.
			if(c == DefaultCommands.cmdOk || c == DefaultCommands.cmdYes || c == Alert.DISMISS_COMMAND)
				handleOkCommand(d);
