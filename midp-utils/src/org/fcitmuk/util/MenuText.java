...
//	private static boolean initiatializeProperties() {
//		if (prop == null) {
//			prop = new Properties();
//			try {
//				prop.load(MenuText.class.getResourceAsStream("settings.txt"));
//				return true;
//			} catch (IOException e) {
//				e.printStackTrace();
//				return false;
...
//	}
	...
	public static String EXIT_PROMPT() {
		return getText(
				(short) 28,
				"Do you really want to exit the application and lose any unsaved changes if any?");
	}
	...
	public static String UPLOAD_BEFORE_DOWNLOAD_PROMPT() {
		return getText(
				(short) 51,
				"has unploaded data. Please first upload or delete this data before getting new form definitions.");
	}

	public static String DOWNLOAD_STUDY_FORMS_PROMPT() {
		return getText((short) 52,
				"Do you really want to download forms in Study: ?");
	}
	...
	public static String UN_UPLOADED_DATA_PROMPT() {
		return getText(
				(short) 54,
				"There is data which is not yet uploaded to the server. Please first upload or delete this data before getting a new list of");
	}

	// string added by Omar 23-9-10
	public static String UN_UPLOADED_DATA_DELETE_PROMPT() {
		return getText(
				(short) 128,
				"There is data which is not yet uploaded to the server. Would like to delete this data first?");
	}

	//
	// string added by Omar on 24-9-10
	public static String UN_UPLOADED_DATA_DELETED() {
		return getText((short) 129, "The unuploaded data has been deleted.");
	}
	...
	public static String DOWNLOAD_STUDIES_PROMPT() {
		return getText((short) 57,
				"Do you really want to download the list	 of studies?");
	}

	public static String DOWNLOAD_LANGUAGES_PROMPT() {
		return getText((short) 58,
				"Do you really want to download the list of languages?");
	}
	...
	public static String UPLOAD_DATA_PROMPT() {
		return getText((short) 60,
				"Do you really want to upload the collected data?");
	}
	...
	public static String LANGUAGE_DOWNLOAD_SAVED() {
		return getText((short) 77,
				"Languages(s) downloaded and saved successfully");
	}
	...
	public static String PROBLEM_CLEANING_STORE() {
		return getText((short) 81,
				"Data uploaded but problem occured cleaning local store");
	}
	...
	public static String SERVER_PROCESS_FAILURE() {
		return getText((short) 90,
				"Problems occured while processing request on server.");
	}
	...
	public static String NO_VIDEO_CONTROL() {
		return getText((short) 105,
				"Not supported by this device. (No video control)");
	}
	...
	public static String FORM_DATA_DISPLAY_PROBLEM() {
		return getText((short) 118,
				"Problem displaying form data. Possibly data out of sync with form definition.");
	}
	...
	// public static String NO_VISIBLE_QUESTION(){return
	// getText((short)122,"No visible question found among the");}
	public static String QUESTIONS() {
		return getText((short) 123, "questions");
	}

	public static String FORM_CLOSE_PROMPT() {
		return getText((short) 124,
				"Do you want to close this form without saving any changes you may have made?");
	}

	public static String REQUIRED_PROMPT() {
		return getText((short) 125,
				"Please enter missing values for fields marked with '*'");
	}

	public static String ANSWER_MINIMUM_PROMPT() {
		return getText((short) 126,
				"Please answer atleast one question or choose Cancel");
	}
	...
	public static String NO_LANGUAGES_FOUND() {
		return getText((short) -2,
				"No languages found. Do you want to download them?");
	}
	...
	public static String MENU_TEXT_DOWNLOAD_SAVED() {
		return getText((short) -6,
				"Menu text downloaded and saved successfully");
	}
	...
	public static String FORM_DOWNLOAD_URL() {
		return getText((short) -8, "Forms download url:");
	}
	...
	public static String DATA_DELETE_PROMPT() {
		return getText((short) -10,
				"Do you really want to delete data collected on this form?");
	}

	public static String NO_MENU_TEXT() {
		return getText((short) -11,
				"The server has no Menu Text for this language");
	}

	public static String MENU_TEXT_DOWNLOAD_PROMPT() {
		return getText((short) -12,
				"Do u want to download the menu for this language?");
	}

/*	// method added by Omar on 16-11-10
	public static String getURL() {
		if (prop == null) {
			initiatializeProperties();
			}
